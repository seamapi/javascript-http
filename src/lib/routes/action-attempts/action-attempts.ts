...
export class SeamHttpActionAttempts {
  ...
  /**
   * Creates a new SeamHttpActionAttempts from an existing HTTP client.
   */
  static fromClient(
  ...
  /**
   * Creates a new SeamHttpActionAttempts authenticated with an API key.
   */
  static fromApiKey(
  ...
  /**
   * Creates a new SeamHttpActionAttempts authenticated with a client session token.
   */
  ...
  /**
   * Creates a new SeamHttpActionAttempts authenticated with a console session token
  ...
  /**
   * Creates a new SeamHttpActionAttempts authenticated with a personal access token
   * and scoped to a workspace.
   */
